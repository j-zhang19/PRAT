...
parser.add_argument( '-nw', '--num-workers', type=int,  help='Numbers of workers for Cuda', dest='num_workers', default = 0)#8 if processor() != 'arm' else 
#0)#nomultithreadings on M1/M2 :(
